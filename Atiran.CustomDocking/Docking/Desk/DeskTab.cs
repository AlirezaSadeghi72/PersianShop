...
namespace Atiran.CustomDocking.Docking.Desk
{
    public class DeskTab : DockContent
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.DeskTab_FormClosed);
        ...
        private void DeskTab_FormClosed(object sender, FormClosedEventArgs e)
        {
            ((Form)TopLevelControl).MdiChildren.FirstOrDefault(f => f == this)?.Dispose();
